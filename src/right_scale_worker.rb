  ...
  module Plugin
    class RightScaleWorker < Maestro::MaestroWorker
      ...
      def wait
        ...
        timeout = get_field('timeout') || MaestroDev::RightScalePlugin::RightScaleApiHelper::DEFAULT_TIMEOUT
        timeout_interval = get_field('timeout_interval') || MaestroDev::RightScalePlugin::RightScaleApiHelper::DEFAULT_INTERVAL
